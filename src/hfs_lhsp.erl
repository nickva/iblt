...
-type itemKey() :: any().
-opaque hfs() ::
    {hfs_lhsp, Hf_count :: pos_integer(), H1_fun :: hfs_beh:hfs_fun(), H2_fun :: hfs_beh:hfs_fun()}.
...
-spec apply_val_rem_helper_feeder(
    ...
    {Hf_count :: 1..100, HashValue2 :: non_neg_integer(), Rem :: pos_integer(), Acc :: Hashes}
when
    is_subtype(Hashes, [non_neg_integer(), ...]).
...
-spec tester_create_hfs(
    {hfs_lhsp, Hf_count :: 1..100, H1_fun :: hfs_beh:hfs_fun(), H2_fun :: hfs_beh:hfs_fun()}
) -> hfs().
